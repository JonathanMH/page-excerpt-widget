...
<div class="wrap">
		...
		<p><?php _e("Page Excerpt length in characters: " ); ?><input type="text" name="jmh_pew_page_excerpt_length" value="
<?php if (isset($jmh_pew_page_excerpt_length)){
	echo $jmh_pew_page_excerpt_length;
};
?>" size="20"><?php _e(" ex: 500" ); ?></p>
		<p>
